...
(function(M, S) {
    ...
    (function(a) {
        ...
        a.Fx.prototype = {
            ...
            initPath: function(m, f, l) {
                ...
                function t(a, c) {
                    for (var q = (v - a.length) / e; 0 < q && q--;) y = a.slice().splice(a.length / J - e, e * J), y[0] = c[v - e - q * e], b && (y[e - 6] = y[e - 2], y[e - 5] = y[e - 1]), [].splice.apply(a, [a.length / J, 0].concat(y)), D && q--
                }
                f = f || "";
                var g, d = m.startX,
                    k = m.endX,
        ...
        a.numberFormat = function(m, f, l, r) {
            ...
            var u = a.defaultOptions.lang,
                ...
                g, d, k = m.toString().split("e"); - 1 === f ? f = Math.min(t, 20) : a.isNumber(f) || (f = 2);
    ...
    (function(a) {
        ...
        a.Color.prototype = {
            ...
            init: function(f) {
                ...
                else if (f && "#" === f.charAt() && (l = f.length, f = parseInt(f.substr(1), 16), 7 === l ? r = [(f & 16711680) >> 16, (f & 65280) >>
                        8, f & 255, 1
                    ] : 4 === l && (r = [(f & 3840) >> 4 | (f & 3840) >> 8, (f & 240) >> 4 | f & 240, (f & 15) << 4 | f & 15, 1])), !r)
    ...
    (function(a) {
        ...
        e(C.prototype, {
            ...
            applyTextOutline: function(x) {
                var h = this.element,
                    c, w, p, e, q; - 1 !== x.indexOf("contrast") && (x = x.replace(/contrast/g, this.renderer.getContrast(h.style.fill)));
                x = x.split(" ");
                w = x[x.length - 1];
            ...
            getBBox: function(a, h) {
                ...
                if (!x) {
                    ...
                    c.isSVG && (a = x.width, c = x.height, q && "11px" === q.fontSize &&
                        17 === Math.round(c) && (x.height = c = 14), h && (x.width = Math.abs(c * Math.sin(w)) + Math.abs(a * Math.cos(w)), x.height = Math.abs(c * Math.cos(w)) + Math.abs(a * Math.sin(w))));
                    if (G && 0 < x.height) {
        ...
        e(A.prototype, {
            ...
            init: function(a, h, w, p, q, e) {
                ...
                x = p.element;
                a.appendChild(x); - 1 === a.innerHTML.indexOf("xmlns") &&
            ...
            symbols: {
                ...
                callout: function(a, h, c, w, p) {
                    ...
                    e && e > c ? p > h + b && p < h + w - b ? d.splice(13, 3, "L", a + c, p - 6, a + c + 6, p, a + c, p + 6, a + c, h + w - q) : d.splice(13, 3, "L", a + c, w / 2, e, p, a + c, w / 2, a + c, h + w - q) : e && 0 > e ? p > h + b && p < h + w - b ? d.splice(33, 3, "L", a, p + 6, a - 6, p, a, p - 6,
                        a, h + q) : d.splice(33, 3, "L", a, w / 2, e, p, a, w / 2, a, h + q) : p && p > w && e > a + b && e < a + c - b ? d.splice(23, 3, "L", e + 6, h + w, e, h + w + 6, e - 6, h + w, a + q, h + w) : p && 0 > p && e > a + b && e < a + c - b && d.splice(3, 3, "L", e - 6, h, e, h - 6, e + 6, h, c - q, h);
                    return d
                }
            },
        ...
        a.svg || (A = {
            ...
            shadow: function(a, b, e) {
                ...
                if (a) {
                    f = v(a.width, 3);
                    D = (a.opacity || .15) / f;
                    for (q = 1; 3 >= q; q++) k = 2 * f + 1 - 2 * q, e && (H = this.cutOffPath(w.value, k + .5)), h = ['\x3cshape isShadow\x3d"true" strokeweight\x3d"',
            ...
            color: function(c,
                ...
                if (k) {
                    var w, v, H = c.linearGradient || c.radialGradient,
                        f, D, y, x, r, B = "";
                    c = c.stops;
                    var l, G = [],
                        m = function() {
    ...
    (function(a) {
        ...
        C.prototype.getLogTickPositions = function(a, l, r, u) {
            ...
            if (.5 <= a) a = Math.round(a), b = this.getLinearTickPositions(a, l, r);
            else if (.08 <= a)
        ...
        a.Tooltip.prototype = {
            ...
            getPosition: function(a, g, b) {
                var e = this.chart,
                    ...
                    k = {},
                    n = b.h || 0,
                    f, l = ["y", e.chartHeight, g, b.plotY + e.plotTop, e.plotTop, e.plotTop + e.plotHeight],
    ...
    (function(a) {
        ...
        a.LegendSymbolMixin = {
            ...
            drawLineMarker: function(a) {
                ...
                d && !1 !== d.enabled &&
                    (b = Math.min(u(d.radius, k), k), 0 === this.symbol.indexOf("url") && (d = r(d, {
                        width: f,
                        height: f
    ...
    (function(a) {
        ...
        a.Series = a.seriesType("line", null, {
            ...
            processData: function(b) {
                ...
                for (k = c.length ||
                    1; --k;) d = m ? q(c[k]) - q(c[k - 1]) : c[k] - c[k - 1], 0 < d && (void 0 === f || d < f) ? f = d : 0 > d && this.requireSorting && a.error(15);
                this.cropped = p;
                this.cropStart = h;
            ...
            drawPoints: function() {
                var a = this.points,
                    ...
                    k, q, n, l, m = this[this.specialGroup] || this.markerGroup,
            ...
            getGraphPath: function(a, b, c) {
                ...
                t(a, function(h, g) {
                    ...
                    h.isNull && !u(b) && 0 < g ? q = !d.connectNulls : h.isNull && !b ? q = !0 : (0 === g || q ? g = ["M", h.plotX, h.plotY] : e.getPointSpline ?
        ...
        f("area", "line", {
            ...
            getStackPoints: function(f) {
                var l = [],
                    ...
                    e = g.series,
                    v = e.length,
                    y, n = E(g.options.reversedStacks, !0) ? 1 : -1,
                    D;
                f = f || this.points;
            ...
            getGraphPath: function(a) {
                var f = m.prototype.getGraphPath,
                    ...
                    e = [],
                    v = this.index,
                    y, n = g.stacks[this.stackKey],
                    D = l.threshold,
                    A = g.getThreshold(l.threshold),
                    c, l = l.connectNulls || "percent" === t,
                    G = function(c, d, f) {
                        var k = a[c];
                        c = t && n[k.x].points[v];
                        var l = k[f + "Null"] || 0;
        ...
        u("column", "line", {
            ...
            animate: function(a) {
                var d = this,
                    ...
                    g = {};
                t && (a ?
                    (g.scaleY = .001, a = Math.min(f.pos + f.len, Math.max(f.pos, f.toPixels(b.threshold))), e ? g.translateX = a - f.len : g.translateY = a, d.group.attr(g)) : (g[e ? "translateX" : "translateY"] = f.pos, d.group.animate(g, E(C(d.options.animation), {
                        step: function(a, b) {
                            d.group.attr({
        ...
        a.CenteredSeriesMixin = {
            getCenter: function() {
                var a = this.options,
                    ...
                    r = Math.min(f, E),
                    u, t;
                for (u = 0; 4 > u; ++u) t = l[u], a = 2 > u || 2 === u && /%$/.test(t), l[u] = A(t, [f, E, r, l[2]][u]) + (a ? m : 0);
                l[3] > l[2] && (l[3] = l[2]);
                return l
            }
        }
    ...
    (function(a) {
        ...
        t("pie", "line", {
            ...
            updateTotals: function() {
                ...
                this.total = f;
                for (a = 0; a < e; a++) g = b[a], g.percentage = 0 < f && (g.visible || !l) ? g.y / f * 100 : 0, g.total = f
            },
            generatePoints: function() {
    ...
    (function(a) {
        ...
        d.prototype.drawDataLabels = function() {
            var b = this,
                ...
                g = d.dataLabels,
                k = b.points,
                l, m, c = b.hasRendered || 0,
                u, q, B = t(g.defer, !!d.animation),
                A = b.chart.renderer;
        ...
        d.prototype.alignDataLabel = function(a, b, d, f, g) {
            ...
            if (u && (r = d.style.fontSize, r = e.renderer.fontMetrics(r, b).b, f = m({
                    ...
                    align: v
                }), l = (p + 720) % 360, l = 180 < l && 360 > l, "left" === v ? k.y -= l ? n.height : 0 : "center" === v ? (k.x -= n.width / 2, k.y -= n.height / 2) : "right" === v && (k.x -= n.width, k.y -= l ? 0 : n.height)) : (b.align(d, null, f), k = b.alignAttr), y ? a.isLabelJustified = this.justifyDataLabel(b, d, k, n, f, g) : t(d.crop, !0) && (u = e.isInsidePlot(k.x,
    ...
    (function(a) {
        ...
        C.prototype.hideOverlappingLabels = function(a) {
            var f = a.length,
                m, u, t, g, d, k, b, e, v, y = function(a, b, d, c, e, f, g, k) {
