        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                <li><a href="<c:url value='/PizzaList.pz' />">피자 메뉴 관리</a></li>
                <li><a href="<c:url value='/SideMenu.do'/>">사이드 메뉴 관리</a></li>
                <li><a href="<c:url value='/ToppingMenu.do'/>">토핑 메뉴 관리</a></li>
...
<!--                
         ...
         <!-- 
          ...
          <li><a href="<c:url value='/SalesGraph.do' />" id="Sales">매출 확인</a></li>
          </ul>
