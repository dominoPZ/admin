	...
	<jsp:include page="/temp/top.jsp" />
      ...
      <article class="container">
        ...
        <form class="form-horizontal" method="get"  name="fr" id="fr"  action="<c:url value='/StoreInsertController.do' />" >
          ...
          <div class="col-sm-6">
            <input name="st_name" class="form-control" name="p_name" id="st_name" type="text" placeholder="매장명">
          </div>
        </div>
       ...
       <div class="form-group">
          ...
          <div class="col-sm-6">
            <input class="form-control" id="tel" type="text" name="st_tel" placeholder="매장 전화번호">
          </div>
        </div>
...
<!--
  ...
  <div class="form-group">
       ...
       <div class="form-group">
          ...
          <div class="col-sm-6">
            <input class="form-control" id="st_parkin" type="text" name="st_parkin" placeholder="주차장 여부">
          </div>
        </div>
       ...
       <div class="form-group">
          ...
          <div class="col-sm-6">
            <input class="form-control" id="inputName" type="text" name="st_time" placeholder="00:00 - 00:00">
          </div>
        </div>        	
...
<!--           <div class="form-group">
        ...
        <div class="form-group">
          <div class="col-sm-12 text-center">
            <button class="btn btn-primary" type="button" onclick="check();" >매장 추가<i class="fa fa-check spaceLeft"></i></button>
          </div>
